...
export class Favorites {
  ...
  verificarTabela() {
    if (this.entries.length <= 0) {
      document.getElementById('imagem-tabela').style.display =""
    } else {
      document.getElementById('imagem-tabela').style.display = "none";
    }
  }
  ...
  delete(user) {
    // funções de alta orden(higer-order functions)=(map, filter, find, reduce ...)
...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    tr.innerHTML = ` 
      <td class="user">
        <img src="https://github.com/alcamovel.png" alt="" />
        <a href="https://github.com/alcamovel" target="_blank">
          <p>Allyson Campos</p>
          <span>alcamovel</span>
        </a>
      </td>
